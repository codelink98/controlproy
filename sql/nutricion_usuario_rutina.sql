...
CREATE TABLE `usuario_rutina` (
  ...
  PRIMARY KEY (`nombre_usuario`,`id_rutina`),
  KEY `id_rutina` (`id_rutina`),
  CONSTRAINT `usuario_rutina_ibfk_1` FOREIGN KEY (`nombre_usuario`) REFERENCES `usuario` (`nombre`),
  CONSTRAINT `usuario_rutina_ibfk_2` FOREIGN KEY (`id_rutina`) REFERENCES `rutina` (`ID`)
